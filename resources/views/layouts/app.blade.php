...
<head>
  ...
  <link href="assets/css/simul.css" rel="stylesheet">
...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="/#portfolio">Nos produits</a></li>
  ...
  @yield('content')
    ...
    <footer id="footer">
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-6 footer-info">
                ...
                <p>
                  Sacre coeur  <br>
                  Dakar, Sénégal<br><br>
                  <strong>Téléphone:</strong> +221 33 867 67 65<br>
              ...
              <div class="col-lg-2 col-md-6 footer-links">
                ...
                <ul>
                  ...
                  <li><i class="bx bx-chevron-right"></i> <a href="#">Notre équipe</a></li>
              ...
              <div class="col-lg-3 col-md-6 footer-links">
                <h4>Nos services</h4>
                <ul>
                  <li><i class="bx bx-chevron-right"></i> <a href="#">Simulateur de pret </a></li>
                  <li><i class="bx bx-chevron-right"></i> <a href="#">Simulateur d'épargne</a></li>
        ...
        <div class="container">
          <div class="copyright">
            &copy; Copyright <strong><span>mmtoure</span></strong>. All Rights Reserved
          </div>
          <div class="credits">
            ...
            Designed by <a href="#">dev@mmtoure</a>
          </div>
        </div>
      </footer><!-- End Footer -->
      ...
      <script src="assets/js/simul.js"></script>
